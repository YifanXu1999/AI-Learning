...
third_party/json/test/CMakeFiles/test-noexcept.dir/src/unit-noexcept.cpp.o: ../third_party/json/test/src/unit-noexcept.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/Go/ELF/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object third_party/json/test/CMakeFiles/test-noexcept.dir/src/unit-noexcept.cpp.o"
	cd /Go/ELF/build/third_party/json/test && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/test-noexcept.dir/src/unit-noexcept.cpp.o -c /Go/ELF/third_party/json/test/src/unit-noexcept.cpp
...
third_party/json/test/CMakeFiles/test-noexcept.dir/src/unit-noexcept.cpp.i: cmake_force
	...
	cd /Go/ELF/build/third_party/json/test && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /Go/ELF/third_party/json/test/src/unit-noexcept.cpp > CMakeFiles/test-noexcept.dir/src/unit-noexcept.cpp.i
...
third_party/json/test/CMakeFiles/test-noexcept.dir/src/unit-noexcept.cpp.s: cmake_force
	...
	cd /Go/ELF/build/third_party/json/test && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /Go/ELF/third_party/json/test/src/unit-noexcept.cpp -o CMakeFiles/test-noexcept.dir/src/unit-noexcept.cpp.s
...
third_party/json/test/test-noexcept: third_party/json/test/CMakeFiles/test-noexcept.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/Go/ELF/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable test-noexcept"
	cd /Go/ELF/build/third_party/json/test && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/test-noexcept.dir/link.txt --verbose=$(VERBOSE)
...
third_party/json/test/CMakeFiles/test-noexcept.dir/clean:
	cd /Go/ELF/build/third_party/json/test && $(CMAKE_COMMAND) -P CMakeFiles/test-noexcept.dir/cmake_clean.cmake
.PHONY : third_party/json/test/CMakeFiles/test-noexcept.dir/clean

third_party/json/test/CMakeFiles/test-noexcept.dir/depend:
	cd /Go/ELF/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /Go/ELF /Go/ELF/third_party/json/test /Go/ELF/build /Go/ELF/build/third_party/json/test /Go/ELF/build/third_party/json/test/CMakeFiles/test-noexcept.dir/DependInfo.cmake --color=$(COLOR)
