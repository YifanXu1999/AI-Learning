...
third_party/json/test/CMakeFiles/test-to_chars.dir/src/unit-to_chars.cpp.o: ../third_party/json/test/src/unit-to_chars.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/Go/ELF/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object third_party/json/test/CMakeFiles/test-to_chars.dir/src/unit-to_chars.cpp.o"
	cd /Go/ELF/build/third_party/json/test && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/test-to_chars.dir/src/unit-to_chars.cpp.o -c /Go/ELF/third_party/json/test/src/unit-to_chars.cpp
...
third_party/json/test/CMakeFiles/test-to_chars.dir/src/unit-to_chars.cpp.i: cmake_force
	...
	cd /Go/ELF/build/third_party/json/test && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /Go/ELF/third_party/json/test/src/unit-to_chars.cpp > CMakeFiles/test-to_chars.dir/src/unit-to_chars.cpp.i
...
third_party/json/test/CMakeFiles/test-to_chars.dir/src/unit-to_chars.cpp.s: cmake_force
	...
	cd /Go/ELF/build/third_party/json/test && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /Go/ELF/third_party/json/test/src/unit-to_chars.cpp -o CMakeFiles/test-to_chars.dir/src/unit-to_chars.cpp.s
...
third_party/json/test/test-to_chars: third_party/json/test/CMakeFiles/test-to_chars.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/Go/ELF/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable test-to_chars"
	cd /Go/ELF/build/third_party/json/test && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/test-to_chars.dir/link.txt --verbose=$(VERBOSE)
...
third_party/json/test/CMakeFiles/test-to_chars.dir/clean:
	cd /Go/ELF/build/third_party/json/test && $(CMAKE_COMMAND) -P CMakeFiles/test-to_chars.dir/cmake_clean.cmake
.PHONY : third_party/json/test/CMakeFiles/test-to_chars.dir/clean

third_party/json/test/CMakeFiles/test-to_chars.dir/depend:
	cd /Go/ELF/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /Go/ELF /Go/ELF/third_party/json/test /Go/ELF/build /Go/ELF/build/third_party/json/test /Go/ELF/build/third_party/json/test/CMakeFiles/test-to_chars.dir/DependInfo.cmake --color=$(COLOR)
