...
third_party/json/test/CMakeFiles/test-conversions.dir/src/unit-conversions.cpp.o: ../third_party/json/test/src/unit-conversions.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/Go/ELF/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object third_party/json/test/CMakeFiles/test-conversions.dir/src/unit-conversions.cpp.o"
	cd /Go/ELF/build/third_party/json/test && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/test-conversions.dir/src/unit-conversions.cpp.o -c /Go/ELF/third_party/json/test/src/unit-conversions.cpp
...
third_party/json/test/CMakeFiles/test-conversions.dir/src/unit-conversions.cpp.i: cmake_force
	...
	cd /Go/ELF/build/third_party/json/test && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /Go/ELF/third_party/json/test/src/unit-conversions.cpp > CMakeFiles/test-conversions.dir/src/unit-conversions.cpp.i
...
third_party/json/test/CMakeFiles/test-conversions.dir/src/unit-conversions.cpp.s: cmake_force
	...
	cd /Go/ELF/build/third_party/json/test && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /Go/ELF/third_party/json/test/src/unit-conversions.cpp -o CMakeFiles/test-conversions.dir/src/unit-conversions.cpp.s
...
third_party/json/test/test-conversions: third_party/json/test/CMakeFiles/test-conversions.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/Go/ELF/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable test-conversions"
	cd /Go/ELF/build/third_party/json/test && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/test-conversions.dir/link.txt --verbose=$(VERBOSE)
...
third_party/json/test/CMakeFiles/test-conversions.dir/clean:
	cd /Go/ELF/build/third_party/json/test && $(CMAKE_COMMAND) -P CMakeFiles/test-conversions.dir/cmake_clean.cmake
...
third_party/json/test/CMakeFiles/test-conversions.dir/depend:
	cd /Go/ELF/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /Go/ELF /Go/ELF/third_party/json/test /Go/ELF/build /Go/ELF/build/third_party/json/test /Go/ELF/build/third_party/json/test/CMakeFiles/test-conversions.dir/DependInfo.cmake --color=$(COLOR)
