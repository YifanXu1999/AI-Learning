...
third_party/json/test/CMakeFiles/test-pointer_access.dir/src/unit-pointer_access.cpp.o: ../third_party/json/test/src/unit-pointer_access.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/Go/ELF/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object third_party/json/test/CMakeFiles/test-pointer_access.dir/src/unit-pointer_access.cpp.o"
	cd /Go/ELF/build/third_party/json/test && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/test-pointer_access.dir/src/unit-pointer_access.cpp.o -c /Go/ELF/third_party/json/test/src/unit-pointer_access.cpp
...
third_party/json/test/CMakeFiles/test-pointer_access.dir/src/unit-pointer_access.cpp.i: cmake_force
	...
	cd /Go/ELF/build/third_party/json/test && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /Go/ELF/third_party/json/test/src/unit-pointer_access.cpp > CMakeFiles/test-pointer_access.dir/src/unit-pointer_access.cpp.i
...
third_party/json/test/CMakeFiles/test-pointer_access.dir/src/unit-pointer_access.cpp.s: cmake_force
	...
	cd /Go/ELF/build/third_party/json/test && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /Go/ELF/third_party/json/test/src/unit-pointer_access.cpp -o CMakeFiles/test-pointer_access.dir/src/unit-pointer_access.cpp.s
...
third_party/json/test/test-pointer_access: third_party/json/test/CMakeFiles/test-pointer_access.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/Go/ELF/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable test-pointer_access"
	cd /Go/ELF/build/third_party/json/test && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/test-pointer_access.dir/link.txt --verbose=$(VERBOSE)
...
third_party/json/test/CMakeFiles/test-pointer_access.dir/clean:
	cd /Go/ELF/build/third_party/json/test && $(CMAKE_COMMAND) -P CMakeFiles/test-pointer_access.dir/cmake_clean.cmake
...
third_party/json/test/CMakeFiles/test-pointer_access.dir/depend:
	cd /Go/ELF/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /Go/ELF /Go/ELF/third_party/json/test /Go/ELF/build /Go/ELF/build/third_party/json/test /Go/ELF/build/third_party/json/test/CMakeFiles/test-pointer_access.dir/DependInfo.cmake --color=$(COLOR)
